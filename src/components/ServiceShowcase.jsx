...
function ServiceCard({ service, onSelect }) {
  return (
    <motion.article
      ...
      className="group relative aspect-[4/5] cursor-pointer overflow-hidden rounded-3xl border border-white/10 bg-white/[0.025] focus:outline-none focus:ring-2 focus:ring-white/30"
    ...
    >
      ...
      >
        ...
        <div
          aria-hidden
          className="absolute inset-0 opacity-60 mix-blend-screen transition-opacity duration-500 group-hover:opacity-90"
          style={{
  ...
  return (
    <section id="services" className="relative px-6 md:px-12 py-32 md:py-40">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.02] max-w-4xl">
          Six disciplines.{' '}
